...
export interface Consumablefrominventoryitem {
  ...
  craftingrequirements: Consumablefrominventoryitemcraftingrequirements;
}

export interface Consumablefrominventoryitemcraftingrequirements {
  time: string;
  craftbuttonlocaoverride: string;
  craftresource: Consumablefrominventoryitemcraftingrequirementscraftresource;
}

export interface Consumablefrominventoryitemcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Equipmentitem {
  ...
  shopsubcategory2: string;
  craftingrequirements: Equipmentitemcraftingrequirements;
}

export interface Equipmentitemcraftingrequirements {
  silver: string;
  time: string;
  craftingfocus: string;
  craftresource: Equipmentitemcraftingrequirementscraftresource;
}

export interface Equipmentitemcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Furnitureitem {
  ...
  uicraftsoundstart: string;
  uicraftsoundfinish: string;
  craftingrequirements: Furnitureitemcraftingrequirements;
...
export interface Furnitureitemcraftingrequirements {
  time: string;
  craftingfocus: string;
  craftresource: Furnitureitemcraftingrequirementscraftresource[];
}

export interface Furnitureitemcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Hideoutitemcraftingrequirements {
  ...
  time: string;
  craftingfocus: string;
  craftresource: Hideoutitemcraftingrequirementscraftresource[];
}

export interface Hideoutitemcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Journalitem {
  ...
  famefillingmissions: Journalitemfamefillingmissions;
  lootlist: Journalitemlootlist;
}
...
export interface Journalitemfamefillingmissions {
  gatherfame: Journalitemfamefillingmissionsgatherfame;
}

export interface Journalitemfamefillingmissionsgatherfame {
  mintier: string;
  value: string;
  validitem: Journalitemfamefillingmissionsgatherfamevaliditem[];
}

export interface Journalitemfamefillingmissionsgatherfamevaliditem {
  id: string;
}

export interface Journalitemlootlist {
  loot: Journalitemlootlistloot;
}

export interface Journalitemlootlistloot {
  itemname: string;
  itemamount: string;
  weight: string;
  labourerfame: string;
...
export interface Mountcraftingrequirements {
  ...
  time: string;
  craftingfocus: string;
  craftresource: Mountcraftingrequirementscraftresource[];
}

export interface Mountcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
...
export interface Siegebanner {
  ...
  canbeovercharged: string;
  shopsubcategory2: string;
  craftingrequirements: Siegebannercraftingrequirements;
}

export interface Siegebannercraftingrequirements {
  silver: string;
  time: string;
  craftingfocus: string;
  craftresource: Siegebannercraftingrequirementscraftresource[];
}

export interface Siegebannercraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Trackingitem {
  ...
  canbeovercharged: string;
  shopsubcategory2: string;
  craftingrequirements: Trackingitemcraftingrequirements;
}

export interface Trackingitemcraftingrequirements {
  silver: string;
  time: string;
  craftingfocus: string;
  craftresource: Trackingitemcraftingrequirementscraftresource[];
}

export interface Trackingitemcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Transformationweapon {
  ...
  craftingrequirements: Transformationweaponcraftingrequirements;
...
export interface Transformationweaponcraftingrequirements {
  silver: string;
  time: string;
  craftingfocus: string;
  craftresource: Transformationweaponcraftingrequirementscraftresource[];
}

export interface Transformationweaponcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
...
export interface Weapon {
  ...
  craftingrequirements: Weaponcraftingrequirements;
...
export interface Weaponcraftingrequirements {
  silver: string;
  time: string;
  craftingfocus: string;
  craftresource: Weaponcraftingrequirementscraftresource[];
}

export interface Weaponcraftingrequirementscraftresource {
  uniquename: string;
  count: string;
}
